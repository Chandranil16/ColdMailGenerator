...
class Chain:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, api_key=os.getenv(
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are ABC, a HR at XYZ company. XYZ is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are ABC, HR at XYZ. 
